        ...
        <div className="row">
          <div className="col-lg-3 col-md-3 col-sm-6 col-xs-6 col-ms-12">
            <div className="hi-icon-effect">
              <div className="hi-icon fa icon-layers">
          ...
          <div className="col-lg-3 col-md-3 col-sm-6 col-xs-6 col-ms-12">
            <div className="hi-icon-effect">
              <div className="hi-icon fa icon-heart">
                <svg width="60" height="60" viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="col-lg-3 col-md-3 col-sm-6 col-xs-6 col-ms-12">
            <div className="hi-icon-effect">
              <div className="hi-icon fa icon-tools-2">
          ...
          <div className="col-lg-3 col-md-3 col-sm-6 col-xs-6 col-ms-12">
            <div className="hi-icon-effect">
              <div className="hi-icon fa icon-globe">
      ...
      <div className="container mt-5 mb-5">
        <div className="row">
          <div className="col-md-6 offset-md-3">
            <h4>Tot/cot/MDRTs 及團隊獎項</h4>
            <ul className="timeline">
              <li>
                <div className="award-name"><b>Award 1</b></div>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. </p>
              </li>
              <li>
                <div className="award-name"><b>Award 2</b></div>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. </p>
              </li>
              <li>
                <div className="award-name"><b>Award 3</b></div>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. </p>
              </li>
            </ul>
          </div>
